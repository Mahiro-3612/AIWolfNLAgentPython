...
# タスク
対象エージェントAgent[{target_agent_id}]が他のエージェントに関してどのような発言をしているか、どのような役職をカミングアウトしているか、また占い師にどのように占われているかに注目して、対象エージェントが市民陣営である確率がどれくらいかを判定してください。
例えば、占い師とカミングアウトしている人が一人の場合は、市民陣営である確率は、カミングアウトした占い師: 100%, '市民'と占われたエージェント: 100%, '人狼'と占われたエージェント: 0%, '人狼'が確定していない状況で、占われていないエージェント": 66%となる。
...
"""
    ...
    input = {
        ...
        "day_colour_scale": get_str_day_colour_scale(day_colour_scale),
